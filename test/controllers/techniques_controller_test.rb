...
class TechniquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create technique' do
    assert_difference('Technique.count') do
      post techniques_url, params: { 
        technique: { 
          principal_position: @technique.principal_position,
          secondary_position: @technique.secondary_position,
          strong_foot: @technique.strong_foot
        } 
      }
    end
  ...
  test 'should update technique' do
    patch technique_url(@technique), params: { 
      technique: { 
        principal_position: @technique.principal_position,
        secondary_position: @technique.secondary_position,
        strong_foot: @technique.strong_foot
